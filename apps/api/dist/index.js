...
var import_core = require("@garden-calm/core");
function setupWebSocketServer(server2) {
  const wss = new import_ws.Server({ server: server2 });
  const orchestrator = (0, import_core.createEmpathyOrchestrator)({
