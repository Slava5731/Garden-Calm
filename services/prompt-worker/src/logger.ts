...
export const logger = winston.createLogger({
  ...
  transports: [
    ...
    new winston.transports.File({ filename: 'logs/prompt-worker-error.log', level: 'error' }),
    new winston.transports.File({ filename: 'logs/prompt-worker.log' })
  ]
});
